...
package com.example.mobileffmpeg;
...
import com.example.mobileffmpeg.util.DialogUtil;
import com.example.mobileffmpeg.util.ResourcesUtil;
...
import static com.example.mobileffmpeg.MainActivity.TAG;
...
public class VideoTabFragment extends Fragment implements AdapterView.OnItemSelectedListener {
    ...
    public void encodeVideo() {
        ...
        try {
            ...
            Log.d(Config.TAG, String.format("Testing VIDEO encoding with '%s' codec", videoCodec));
                    ...
                    MainActivity.addUIAction(new Callable<Object>() {
                        ...
                        public Object call() {
                            if (returnCode == RETURN_CODE_SUCCESS) {
                                Log.d(Config.TAG, "Encode completed successfully; playing video.");
                                playVideo();
                            } else {
                                Popup.show(requireContext(), "Encode failed. Please check log for the details.");
                                Log.d(Config.TAG, String.format("Encode failed with rc=%d.", returnCode));
                            }
            ...
            Log.e(Config.TAG, String.format("Encode video failed %s.", Exceptions.getStackTraceString(e)));
